                            ...
                            <tbody>
                                {cartItems.map((item) => (
                                    <tr key={item.cartId} style={{ backgroundColor: item.cartId % 2 === 0 ? '#f9f9f9' : '#fff' }}>
                                        ...
                                        <td className="text-end">Q{(item.unitPrice || 0).toFixed(2)}</td>
                                        <td className="text-end">Q{(item.discount || 0).toFixed(2)}</td>
                                        <td className="text-end">Q{(item.salePrice || 0).toFixed(2)}</td>
                                        <td className="text-end">Q{(item.subtotal || 0).toFixed(2)}</td>
                                        <td>
                            ...
                            <div className="card border-0 bg-light">
                                <div className="card-body p-0">
                                    <div className="d-flex justify-content-between mb-2">
                                        ...
                                        <h5 className="mb-0">Q {(total || 0).toFixed(2)}</h5>
                                    </div>
